This repository contains links to Flowset Tasklist resources and supporting configuration files for running Docker
...
1. [docker-compose.yaml](docker-compose.yaml) which contains the Flowset Tasklist only.
...
3. Configure the language which should be used to display Flowset Tasklist UI (by default, English is used):
